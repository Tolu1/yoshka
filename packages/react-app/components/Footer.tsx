  ...
  return (
    <footer className="bg-gray-700" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="mt-16 text-center border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">&copy; {new Date().getFullYear()} Yoshka - <a href="https://x.com/persecutepower" className="hover:text-gray-500">Persecute Power</a>. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
