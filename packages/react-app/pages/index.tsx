  ...
  return (
    <div>
      <main className="-mt-32">
                ...
                <div className="flex items-center justify-center">
                    <div className="sm:border-gray-200 sm:border-b">
                        <nav className="flex flex-wrap -mb-px sm:space-x-10">
                            <div id="explore" onClick={handleSwitch} className={`inline-flex items-center w-1/2 text-sm font-medium  transition-all duration-200 sm:w-auto sm:border-b-2 sm:py-4 group whitespace-nowrap ${activeTab === "explore"? 'text-indigo-600 sm:border-indigo-600 ' : 'text-gray-500 hover:text-gray-900 hover:border-gray-300 sm:border-transparent'}`}>
                            ...
                            <div id="my-songs" onClick={handleSwitch} className={`inline-flex items-center w-1/2 text-sm font-medium  transition-all duration-200 sm:w-auto sm:border-b-2 sm:py-4 group whitespace-nowrap ${activeTab === "my-songs"? 'text-indigo-600 sm:border-indigo-600 ' : 'text-gray-500 hover:text-gray-900 hover:border-gray-300 sm:border-transparent'}`}> 
                            ...
                            <div id="nfts" onClick={handleSwitch} className={`inline-flex items-center w-1/2 text-sm font-medium  transition-all duration-200 sm:w-auto sm:border-b-2 sm:py-4 group whitespace-nowrap ${activeTab === "nfts"? 'text-indigo-600 sm:border-indigo-600 ' : 'text-gray-500 hover:text-gray-900 hover:border-gray-300 sm:border-transparent'}`}>
        ...
        {/* Tab Content */}  
        {activeTab === 'explore' && <div>Explore samples and stems</div>}
        {activeTab === 'my-songs' && <MySongs />}
        {activeTab === 'nfts' && <div>NFTs section</div>}
